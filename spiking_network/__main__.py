...
def main():
    ...
    parser.add_argument("-s", "--cluster_sizes", type=list, default=[20, 10, 10], help="Size of each cluster")
    ...
    parser.add_argument("-d", "--n_datasets", type=int, default=200, help="Number of datasets to generate")
