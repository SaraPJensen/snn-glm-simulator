...
class ConnectivityDataset:
    @classmethod
    def from_list(cls, w0_list):   #Presumably, this is where the W0_hubs etc must be included 
    ...
    # def _generate_data(self, n_neurons, n_datasets, seed=0, **kwargs):   #Not in use
    #     datasets = []
    #     rng = torch.Generator()
    #     print("Used the function _generate_data")
    ...
    #     print("RETURNING THE NUMBER OF NODES!!!")
    #     return datasets
