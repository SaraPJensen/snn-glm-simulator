...
def main():
    ...
    parser.add_argument("-cs", "--cluster_sizes",               type=list,      default=[20, 30, 10],                   help="Size of each cluster")
    ...
    parser.add_argument("-p", "--max_parallel",                 type=int,       default=40,                    help="The max number of simulations to run in parallel")
    ...
    sara_simulate(args.network_type, args.cluster_sizes, args.random_cluster_connections, args.n_sims, args.n_steps, args.data_path, args.max_parallel, args.threshold, args.remove_connections, args.add_connections, args.seed)
