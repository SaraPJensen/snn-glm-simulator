...
def main():
    ...
    parser.add_argument("-cs", "--cluster_sizes",               type=list,      default=[5, 6, 7],           help="Size of each cluster")
    ...
    parser.add_argument("-th", "--threshold",                   type=float,     default=4.2,                    help="The threshold to use for small world or barabasi networks")
    parser.add_argument("-t", "--n_steps",                      type=int,       default=10000,                 help="Number of steps in simulation")
    parser.add_argument("-sims", "--n_sims",                    type=int,       default=1,                    help="Number of simulations to run")
